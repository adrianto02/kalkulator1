...
public class MainActivity extends AppCompatActivity {
    ...
    private void viewSetup(){
        b1 = findViewById(R.id.satu_button);
        b2 = findViewById(R.id.dua_button);
        b3 = findViewById(R.id.tiga_button);
        b4 = findViewById(R.id.empat_button);
        b5 = findViewById(R.id.lima_button);
        b6 = findViewById(R.id.enam_button);
        b7 = findViewById(R.id.tujuh_button);
        b8 = findViewById(R.id.delapan_button);
        b9 = findViewById(R.id.sembilan_button);
        b0 = findViewById(R.id.nol_button);
        b_equal = findViewById(R.id.equal_button);
        b_multi = findViewById(R.id.kali_button);
        b_divide = findViewById(R.id.bagi_button);
        b_add = findViewById(R.id.tambah_button);
        b_sub = findViewById(R.id.kurang_button);
        b_clear = findViewById(R.id.AC_button);
        b_dot = findViewById(R.id.point_button);
        b_para1 = findViewById(R.id.percent_button);
        b_para2 = findViewById(R.id.neg_button);
